...
export const createAuction = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `${process.env.BACKEND_URL}/api/v1/auctionitem/create`,
      data,
      {
        withCredentials: true,
...
export const republishAuction = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `${process.env.BACKEND_URL}/api/v1/auctionitem/item/republish/${id}`,
      data,
      {
        withCredentials: true,
...
export const deleteAuction = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${process.env.BACKEND_URL}/api/v1/auctionitem/delete/${id}`,
      {
        withCredentials: true,
      }
    );
